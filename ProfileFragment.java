...
public class ProfileFragment extends Fragment implements TextWatcher {
    ...
    Button btn_change_password_submit, btn_go_to_edit_profile, btn_profile_bus_pass, btn_profile_change_password, btn_profile_logout, btn_help_desk;
...
//                startActivity(iChangePassword);
        ...
        btn_help_desk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getActivity(), ActivityHelpDesk.class));
            }
        });
    }
...
//                dialogPlus.show();
    ...
    private void initialize() {
        ...
        btn_help_desk = view.findViewById(R.id.btn_help_desk);
