    ...
    private void daily() {
        ...
        dbreference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                dbvalidity = Objects.requireNonNull(snapshot.child("daily").child("validity").getValue()).toString();
                dbprice = Objects.requireNonNull(snapshot.child("daily").child("price").getValue()).toString();
                sbenefit1= Objects.requireNonNull(snapshot.child("daily").child("benefits").child("Benefit1").getValue()).toString();
                sbenefit2= Objects.requireNonNull(snapshot.child("daily").child("benefits").child("Benefit2").getValue()).toString();
                sbenefit3= Objects.requireNonNull(snapshot.child("daily").child("benefits").child("Benefit3").getValue()).toString();
                sbenefit4= Objects.requireNonNull(snapshot.child("daily").child("benefits").child("Benefit4").getValue()).toString();
                sbenefit5= Objects.requireNonNull(snapshot.child("daily").child("benefits").child("Benefit5").getValue()).toString();
                title.setText(R.string.dailypass);
