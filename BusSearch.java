            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(snapshot.exists()){
                    for (DataSnapshot fromToSnapshot : snapshot.getChildren()){
                        System.out.println("Snapshot key: " + fromToSnapshot.getKey());
                        if (fromToSnapshot.getKey().equals(fromLocation+toLocation)){
                            for (DataSnapshot busNoSnapshot : fromToSnapshot.getChildren()){
                                ...
                                if (busNoSnapshot.exists()){
                                    ...
                                    busList.add(busItem);
                                    Toast.makeText(BusSearch.this, "added", Toast.LENGTH_SHORT).show();
                                }
                                else {
                                    Toast.makeText(BusSearch.this, "No Bus Found", Toast.LENGTH_SHORT).show();
                                    break;
                                }
